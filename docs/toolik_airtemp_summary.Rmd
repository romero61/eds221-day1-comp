...
## One awesome cleaning tool: {janitor} pipe_shrtct = cmd + shift + m

...and meet the pipe operator!

I don't want to deal with those capital letters. These aren't even bad looking column names, but let's clean them up a bit. Takes columns names and puts them into a 'case' you specify
Start with this object and then (%>%) filter this input and then(%>%) select...
